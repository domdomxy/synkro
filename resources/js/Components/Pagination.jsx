                    ...
                    {showJumpButtons && (
                        <div className="ml-1 flex items-center gap-1 border-l border-gray-200 pl-2 dark:border-gray-700">
                            ...
                            <input
                                ...
                                className="w-12 rounded-md border-gray-300 px-2 py-1 text-xs leading-4 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:w-14 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                            />
                        </div>
                    )}
                </nav>

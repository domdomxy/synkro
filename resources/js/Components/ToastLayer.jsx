...
// bottom-20 on mobile clears the fixed BottomNavBar (h-16) plus its safe-area
...
export default function ToastLayer() {
    return (
        <div className="fixed bottom-20 left-1/2 z-[60] flex w-[calc(100%-2rem)] max-w-sm -translate-x-1/2 flex-col gap-2 sm:bottom-4 sm:left-auto sm:right-4 sm:w-auto sm:max-w-sm sm:translate-x-0">
            <FlashMessages />
            <NotificationToast />
        </div>
    );

    ...
    return createPortal(
        <div ref={ref} style={{ position: 'fixed', top: position.top, left: position.left }} className="z-50 w-52">
            ...
            <div className="relative flex flex-col gap-2.5 rounded-lg border border-gray-200 bg-white p-3.5 shadow-lg dark:border-gray-600 dark:bg-gray-800">
                ...
                {dayStats && topUser && (
                    // Admin view only: min/max/avg sessions per user that
                    // day. Personal view (topDevice) skips this - per-device
                    // breakdown isn't shown there.
                    <div>
                        <p className="mb-1.5 text-[10px] text-gray-400 dark:text-gray-500">Sessions per user</p>

            ...
            <div className="py-8">
                <div className="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-wrap gap-3">
                        ...
                        <Link href={route('admin.projects')} className="rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-500">View Projects</Link>
                        ...
                        <Link href={route('admin.logs')} className="ml-auto flex items-center gap-1.5 rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-500">

...
export default function Feedback({ flash, categories, trackingId: trackingIdFromUrl, from }) {
    // When opened via Settings > Support (itself reached through the
    // AuthenticatedLayout's section nav / mobile dropdown), the "back" action
    // should return there instead of the home page.
        ...
        <>
            ...
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
                    ...
                    <Modal show onClose={closeFeedback} maxWidth="4xl" overlayClassName="bg-transparent" panelClassName="border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">

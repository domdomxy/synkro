                            ...
                            <ul>
                                {notificationsList.data.map((note) => {
                                    ...
                                    return (
                                        <li
                                            key={note.id}
                                            className={`group flex items-center gap-2 border-b border-gray-50 px-4 py-2.5 transition last:border-b-0 hover:bg-gray-50 dark:border-gray-700/50 dark:hover:bg-gray-700/30 ${

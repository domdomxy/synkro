...
export default function Edit({ mustVerifyEmail, status, deletionRequestedAt, deletionGraceDays }) {
    ...
    // Account opens as a modal over whatever page it was launched from (the
    // account dropdown works everywhere), same pattern as Settings.jsx.
    const closeAccount = () => {
    ...
    return (
        <AuthenticatedLayout>
            ...
            <Modal show onClose={closeAccount} maxWidth="4xl" overlayClassName="bg-black/55 dark:bg-black/70" panelClassName="bg-white dark:bg-gray-900">
